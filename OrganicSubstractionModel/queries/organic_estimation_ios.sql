...
-- FIXME: substract with all known ios networks (ASA, tiktokglobal_int,
...
with ios_double_counts as (
  ...
  select
    ...
    0 as cost_cad,
    0 as cost_usd,
    af.impressions - dc.double_counting_perc * asa.impressions as impressions,
    af.clicks - dc.double_counting_perc * asa.clicks as clicks,
    af.installs - dc.double_counting_perc * asa.installs as installs,
    af.mobile_trials - dc.double_counting_perc * asa.mobile_trials as mobile_trials,
    af.web_trials - dc.double_counting_perc * asa.web_trials as web_trials,
    af.trials - dc.double_counting_perc * asa.trials as trials,
    af.paid - dc.double_counting_perc * asa.paid as paid,
    af.revenues - dc.double_counting_perc * asa.revenues as revenues,
    af.agency,
    af.need_modeling,
