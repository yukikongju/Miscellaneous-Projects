...
from team import TeamAdjancy
    

def main():
    csv_path = 'LineupOptimization/data/dummy_situation1.csv'

    team_kmeans = TeamAdjancy(csv_path, player_method='teamates', graph_method='adjancy', 
                lineup_method='spectral_clustering', cluster_method='kmeans')
    team_fiedler = TeamAdjancy(csv_path, player_method='teamates', graph_method='adjancy', 
